...
import '../../cubit/reel_cubit/reel_cubit.dart';

class EditReelScreen extends StatelessWidget {
...
class _EditPageState extends State<EditPage> {
  ...
  Future<void> _load() async {
    ...
    _videoMetadata = await ProVideoEditor.instance.getMetadata(EditorVideo.file(cubit.state.reelMedia));

    _videoController = VideoPlayerController.file(cubit.state.reelMedia!);
  ...
  Future<void> _generateVideo(CompleteParameters parameters) async {
    ...
    final exportModel = RenderVideoModel(
      id: _taskId,
      video: EditorVideo.file(context.read<ReelCubit>().state.reelMedia),
    ...
    if (!mounted) return;
    //todo: save change
    // context.read<ReelCubit>().saveChange(_outputPath!);
  }
      ...
      builder: (context, state) {
        ...
        return LayoutBuilder(
          builder: (context, constraints) {
            return _proVideoController == null
